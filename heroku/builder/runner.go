...
//Response is an rpc service for handling responses from the process running the
//test.
type Response struct{}

//Post grabs the test output and sends it to the corresponding task managing
//it.
func (Response) Post(req *http.Request, args *hrpc.TestResponse, resp *rpc.None) (err error) {
...
func init() {
	if err := rpcServer.RegisterService(Response{}, ""); err != nil {
		bail(err)
	}
}
